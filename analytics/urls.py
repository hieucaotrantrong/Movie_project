...
urlpatterns = [
    ...
    re_path(r"^api/get_statistics$", views.get_statistics, name="get_statistics"),
    re_path(
        r"^api/events_on_conversions$",
        views.events_on_conversions,
        name="events_on_conversions",
    ),
    re_path(
        r"^api/ratings_distribution$",
        views.ratings_distribution,
